...
if __name__ == '__main__':
    ...
    encoder = Encoder(40, center_len=64, left_len=65536, hop_len=64, right_len=32, num_blocks=2,att_type="rel",
                      rel_pos=0, abs_pos=1, use_mem=0,input_layer="conv2d",subpos=[0,1])
    for i in range(1):
