...
if __name__ == '__main__':
    ...
    encoder = Encoder(40, center_len=64, left_len=64, hop_len=64, right_len=64, num_blocks=6,att_type="win",
                      rel_pos=0, abs_pos=1, use_mem=1,input_layer="linear",subpos=[0,1])
    for i in range(1):
